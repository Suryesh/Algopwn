...
SENSITIVE_ACLS = {
    "addObject", "deleteObject", "deleteIndex", "editSettings", "addUserKey", "deleteUserKey", "editSettings", "browse","seeUnretrievableAttributes","listIndexes","analytics","logs","recommendation"
}
